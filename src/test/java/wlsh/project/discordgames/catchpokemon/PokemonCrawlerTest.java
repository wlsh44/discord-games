package wlsh.project.discordgames.catchpokemon;
...
import wlsh.project.discordgames.catchpokemon.infra.crawl.PokemonCrawler;
...
import wlsh.project.discordgames.catchpokemon.infra.csv.PokemonFormatter;
import wlsh.project.discordgames.catchpokemon.infra.csv.PokemonLinkParser;
...
class PokemonCrawlerTest {
    ...
    void test() throws Exception {
        //given
        PokemonCrawler pokemonCrawler = new PokemonCrawler();

        //when
        pokemonCrawler.crawl();
